...
@section('title', 'Funcionalidades - Real Independent')
...
<section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-6">Tudo que você precisa para gerenciar seu clube</h1>
        <p class="text-xl text-blue-100">Uma plataforma completa com recursos de IA e integração financeira</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Gestão Completa de Atletas</h3>
                <p class="text-gray-600 mb-4">Cadastro completo com histórico médico, performance, documentos e muito mais.</p>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Gestão de Equipes</h3>
                <p class="text-gray-600 mb-4">Organize seus atletas em equipes e categorias de forma simples e eficiente.</p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                        </svg>
                        Múltiplas equipes e categorias
                    </li>
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Controle Financeiro</h3>
                <p class="text-gray-600 mb-4">Gerencie mensalidades, cobranças e pagamentos de forma automatizada.</p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Inteligência Artificial</h3>
                <p class="text-gray-600 mb-4">Planos personalizados de treino e nutrição gerados por IA para cada atleta.</p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Portal do Atleta</h3>
                <p class="text-gray-600 mb-4">Área exclusiva para atletas acompanharem seu desenvolvimento e acessar planos.</p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition">
                ...
                <h3 class="text-xl font-semibold text-gray-900 mb-3">Site Público Automático</h3>
                <p class="text-gray-600 mb-4">Site gerado automaticamente com loja virtual integrada para cada clube.</p>
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
