                ...
                <div class="h-24 flex items-center px-8 border-b border-white/5">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative group">
                            ...
                            @if($siteLogo)
                                <img src="{{ str_starts_with($siteLogo, 'http') ? $siteLogo : route('tenant.assets', ['path' => $siteLogo]) }}" alt="{{ $siteName }}" class="relative h-11 w-auto rounded-xl shadow-2xl">
                            @else
                                <div class="relative h-11 w-11 bg-indigo-600 rounded-xl flex items-center justify-center text-white font-black text-xl shadow-2xl border border-white/10 group-hover:scale-105 transition-transform duration-300">
                                    {{ substr($siteName, 0, 1) }}
                                </div>
                            @endif
                        </div>
