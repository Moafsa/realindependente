                    ...
                    <div class="relative">
                        ...
                        <div id="notification-dropdown" class="hidden absolute right-0 mt-4 w-80 bg-[#0F1423] rounded-[2rem] shadow-2xl border border-white/10 z-50 overflow-hidden backdrop-blur-xl animate__animated animate__fadeInUp animate__faster">
                            ...
                            <div class="max-h-96 overflow-y-auto custom-scrollbar">
                                <a id="pending-plans-notification" href="{{ ($pendingCount ?? 0) > 0 && isset($lastPendingAthleteId) ? route('admin.athletes.show', $lastPendingAthleteId) . '#ai-plans' : (Route::has('admin.athletes.index') ? route('admin.athletes.index') : '#') }}" class="flex p-5 hover:bg-white/5 border-b border-white/5 transition-colors {{ ($pendingCount ?? 0) > 0 ? '' : 'hidden' }}">
