        ...
        <div class="hidden md:flex md:w-64 md:flex-col">
            <div class="flex flex-col flex-grow pt-5 bg-gray-900 overflow-y-auto">
                <div class="flex items-center flex-shrink-0 px-4">
                    ...
                    @endphp
                    @if($siteLogo)
                        <img src="{{ \Storage::url($siteLogo) }}" alt="{{ $siteName }}" class="h-20 w-auto">
                    @else
                        <h1 class="text-4xl font-bold text-blue-600">{{ $siteName }}</h1>
                    @endif
                </div>
                    ...
                    <div class="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
                        ...
                        <div class="relative" id="user-menu">
                            ...
                            <div id="user-menu-dropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl py-2 hidden z-50 border border-gray-100">
                                ...
                                <a href="{{ route('portal.profile') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
