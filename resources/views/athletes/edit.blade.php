        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="dominant_limb" id="dominant_limb" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    ...
                    <option value="Destro" {{ old('dominant_limb', $athlete->dominant_limb) == 'Destro' ? 'selected' : '' }}>Destro</option>
                    <option value="Canhoto" {{ old('dominant_limb', $athlete->dominant_limb) == 'Canhoto' ? 'selected' : '' }}>Canhoto</option>
                    <option value="Ambidestro" {{ old('dominant_limb', $athlete->dominant_limb) == 'Ambidestro' ? 'selected' : '' }}>Ambidestro</option>
                </select>
                @error('dominant_limb')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="url" name="instagram_url" id="instagram_url" value="{{ old('instagram_url', $athlete->instagram_url) }}"
            ...
            <div>
                ...
                <input type="url" name="tiktok_url" id="tiktok_url" value="{{ old('tiktok_url', $athlete->tiktok_url) }}"
            ...
            <div>
                ...
                <input type="url" name="youtube_url" id="youtube_url" value="{{ old('youtube_url', $athlete->youtube_url) }}"
            ...
            <div>
                ...
                <input type="url" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $athlete->facebook_url) }}"
            ...
            <div>
                ...
                <input type="url" name="x_url" id="x_url" value="{{ old('x_url', $athlete->x_url) }}"
